...
class ImageBehave extends Behavior
{
    ...
    public function attachImage($absolutePath, $isMain = false, $name = '')
    {
        ...
        $pic_name = substr(md5(microtime(true) . $absolutePath), 4, 6);
        $pictureFileName =
            $pic_name
            . '.' .
        ...
        $image->pic_name = $pic_name;
        $image->pic_gid = $this->owner->primaryKey;
        $image->pic_ext = pathinfo($absolutePath, PATHINFO_EXTENSION);
